...
//        <div className='filterBox w-full hidden  mx-auto h-12 px-2 pr-5 flex items-center justify-between pb-2  my-2 '
...
const categoryHtml = () => {
  return (
    <div
      className="filterBox w-full  mx-auto h-12 px-2 pr-5 flex items-center justify-between pb-2 my-2"
      ref={filterBox}
    >
      <p
        className="fiterHeading w-1/12 flex justify-center items-center p-2 text-xl font-semibold text-gray-600 bg-[#F230B2]/30 border rounded-full shadow-lg"
        onClick={handleFilterToggle}
      >
        <FontAwesomeIcon icon="fa-solid fa-filter" /> Filter
      </p>

      <div className="filter-container bg-[#FF8F2C]/50 w-10/12 transition-all duration-200 opacity-0 p-2 border rounded-full shadow-lg flex justify-around items-center">
        <div className="filter-group">
          <label htmlFor="category-filter" className="font-bold mr-2">
            Category:
          </label>
